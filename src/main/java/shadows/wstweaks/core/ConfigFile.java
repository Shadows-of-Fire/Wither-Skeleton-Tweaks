	...
	public static void syncConfig() { // Gets called from preInit
		try {
			...
			Property PShardValue = CommonProxy.config.get(Configuration.CATEGORY_GENERAL, "Shard Value", // Property name
					"9", // Default value
					"The value of a skull fragment, in terms of 1/n (How many shards per skull) Valid values are 1-9", Property.Type.INTEGER); // Comment
			Property PEnableLava = CommonProxy.config.get(Configuration.CATEGORY_GENERAL, "Enable Lava Immolation Blade", // Property name
					"true", // Default value
					"If the Immolation Blade (Lava) is enabled", Property.Type.BOOLEAN); // Comment
			Property PEnableBlaze = CommonProxy.config.get(Configuration.CATEGORY_GENERAL, "Enable Blaze Immolation Blade", // Property name
					"true", // Default value
			...
			Property PShardDropChance = CommonProxy.config.get(Configuration.CATEGORY_GENERAL, "Fragment Drop Chance", // Property name
					"1", // Default value
					"The wither skull fragment drop chance in 1/n.  Higher numbers means less drops. Set to 0 to disable.", Property.Type.INTEGER); // Comment
			Property PExtraWitherSkeletons = CommonProxy.config.get(Configuration.CATEGORY_GENERAL, "Extra Wither Skeletons", // Property name
					"0", // Default value
			...
			Property PExtraSpawns = CommonProxy.config.get(Configuration.CATEGORY_GENERAL, "Extra Spawns", // Property name
					"false", // Default value
					"If, when a blaze or pigman spawns on Nether Brick, a wither skeleton spawns with it.", Property.Type.BOOLEAN);
